...
public class CheckoutController implements Initializable {
    ...
    public void computeTotal(ActionEvent event) {
        ...
        // double qty1 = Double.parseDouble(choicebox1.getValue());
        // double qty2 = Double.parseDouble(choicebox2.getValue());
        // double qty3 = Double.parseDouble(choicebox3.getValue());
        ...
        totalSagad = Double.toString(totalAmount);
    ...
    public void gotoorder(ActionEvent event) throws IOException {
       ...
       // OrderController.setTotal(totalSagad);
